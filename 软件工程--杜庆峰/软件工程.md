...
![image-20210913110946750](软件工程.assets/image-20210913110946750.png)
...
![image-20210915105802349](软件工程.assets/image-20210915105802349.png)
...
![image-20210915113258318](软件工程.assets/image-20210915113258318.png)
...
![image-20210926100351370](软件工程.assets/image-20210926100351370.png)
...
![image-20210927104412103](软件工程.assets/image-20210927104412103.png)

线性

迭代

![image-20210927105215302](软件工程.assets/image-20210927105215302-16497303818661.png)
...
![image-20210927112539850](软件工程.assets/image-20210927112539850.png)
...
- 定义接口，说明消息细节（类型等）
  - ![image-20211215111030517](软件工程.assets/image-20211215111030517-16497305488992.png)
  - guard condition：满足某个条件调用（可有可无）
  - 返回值：= 消息名字（参数列表）
  - 一个例子![image-20211215110859686](软件工程.assets/image-20211215110859686.png)
- 为每个构建确定适当接口
- 细化属性，定义属性和数据结构
  - ![image-20211215111313920](软件工程.assets/image-20211215111313920.png)
- 详细描述操作数据流
  - ![image-20211215111331491](软件工程.assets/image-20211215111331491.png)
  - ![image-20211215111634272](软件工程.assets/image-20211215111634272.png)
...
- ![image-20211215112442968](软件工程.assets/image-20211215112442968.png)
- 配置图：怎么运行，怎么部署，网络这么连
